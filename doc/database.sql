...
CREATE TABLE editor_notice(
        id_notice Int NOT NULL ,
        id_editor Int NOT NULL ,
        PRIMARY KEY (id_notice ,id_editor )
)ENGINE=InnoDB;
...
CREATE TABLE collection_notice(
        ...
        PRIMARY KEY (id_notice ,id_collection )
)ENGINE=InnoDB;
...
ALTER TABLE editor_notice ADD CONSTRAINT FK_editor_notice_id_notice FOREIGN KEY (id_notice) REFERENCES notice(id_notice);
ALTER TABLE editor_notice ADD CONSTRAINT FK_editor_notice_id_editor FOREIGN KEY (id_editor) REFERENCES editor(id_editor);
ALTER TABLE collection_notice ADD CONSTRAINT FK_collection_notice_id_notice FOREIGN KEY (id_notice) REFERENCES notice(id_notice);
ALTER TABLE collection_notice ADD CONSTRAINT FK_collection_notice_id_collection FOREIGN KEY (id_collection) REFERENCES collection(id_collection);
